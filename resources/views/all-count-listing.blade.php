        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('D2_good_member') }}</strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('D2_bad_member') }}</strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('member_district1') }}</strong>
                </td>
            </tr>
            <tr>
                <td><strong>DEPENDENT</strong></td>
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('D2_good_dependent') }}</strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('D2_bad_dependent') }}</strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>{{ collect($listingData)->sum('dependent_distric1') }}</strong>
                </td>
            </tr>
            <tr>
                <td><strong>TOTAL</strong></td>
                <td colspan='2' class='center'>
                    <strong>
                        {{ collect($listingData)->sum('D2_good_member') + collect($listingData)->sum('D2_good_dependent') }}
                    </strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>
                        {{ collect($listingData)->sum('D2_bad_member') + collect($listingData)->sum('D2_bad_dependent') }}
                    </strong>
                </td>
                <td colspan='2' class='center'>
                    <strong>
                        {{ collect($listingData)->sum('member_district1') + collect($listingData)->sum('dependent_distric1') }}
                    </strong>
                </td>
            </tr>
        </tbody>
